    ...
    private void loadMenuItems() {
        ...
        menuRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.d("BreakfastMenuActivity", "DataSnapshot exists: " + snapshot.exists());
                itemList.clear();
                ...
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    ...
                    if (!"Breakfast".equals(category)) {
                        continue; // Skip non-Breakfast items
                    }
                    ...
                    Log.d("BreakfastMenuActivity", "Item: " + name + ", Price: " + price + ", Image: " + imageRes);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Log.e("BreakfastMenuActivity", "Error: " + error.getMessage());
                Toast.makeText(BreakfastMenuActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
