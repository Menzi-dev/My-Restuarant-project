    ...
    private void loadMenuItems() {
        ...
        menuRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.d("LunchMenuActivity", "DataSnapshot exists: " + snapshot.exists());
                itemList.clear();
                ...
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    ...
                    Log.d("LunchMenuActivity", "Item: " + name + ", Price: " + price + ", Image: " + imageRes);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Log.e("LunchMenuActivity", "Error: " + error.getMessage());
                Toast.makeText(LunchMenuActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
