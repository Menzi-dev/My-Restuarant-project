    ...
    private void loadMenuItems() {
        ...
        menuRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.d("DrinksMenuActivity", "DataSnapshot exists: " + snapshot.exists());
                itemList.clear();
                ...
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    ...
                    if (!"Drinks".equals(category)) {
                        continue; // Skip non-Drinks items
                    }
                    ...
                    Log.d("DrinksMenuActivity", "Item: " + name + ", Price: " + price + ", Image: " + imageRes);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Log.e("DrinksMenuActivity", "Error: " + error.getMessage());
                Toast.makeText(DrinksMenuActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
